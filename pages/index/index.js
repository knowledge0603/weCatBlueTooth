...
//发送指令
  lanya11: function () {
    ...
    // var hex = '010000000004000A32010101010101010101'
    //运行开关指令
    //var hex = '01000000000400033F050100'
    //关闭活动提醒
    //var hex='0100000000040012AA060D000000007F'
    //关闭活动提醒 全位
    //var   hex='0100000000040012AA060D000000007F000000000000000000'
    //20)	读取当天运动信息指令
    //var hex='0100000000040002500100000000000000000000000000'

    //var hex='0000ffe100001000800000805f9b34fb'
    //var hex='01000000000400025001000000000000'
    //6)	ANCS 开关读取指
    //var hex='01000000000400023A870100'
    var hex='55AA0307850694'
    var typedArray = new Uint8Array(hex.match(/[\da-f]{2}/gi).map(function (h) {
      return parseInt(h, 16)
    }))
    console.log("-----start-------10");
    console.log("-----deviceId-------" + that.data.connectedDeviceId);
    console.log("-----serviceId-------" + that.data.writeServicweId);
  ...
  lanya6: function () {
    var that = this;
    console.log("----step6-------deviceId---" + that.data.connectedDeviceId);
